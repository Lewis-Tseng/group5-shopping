...
<table>
	...
	<tr>
		<td>電話:</td>
		<td><input type="TEXT" name="phone" size="45"	value="<%=memVO.getPhone()%>" /></td>
	</tr>
	<tr>
		<td>地址:</td>
		<td><input type="TEXT" name="address" size="45"	value="<%=memVO.getAddress()%>" /></td>
	</tr>
	<tr>
		<td>郵遞區號:</td>
		<td><input type="TEXT" name="pos_code" size="45"	value="<%=memVO.getPos_code()%>" /></td>
	</tr>
	<tr>
		<td>生日:</td>
		<td><input type="date" name="birthday" id="f_date1" type="text" ></td>
	</tr>
	<tr>
		<td>大頭照:</td>
		<td><input type="file" name="mem_pic" size="45"	value="<%=memVO.getMem_pic()%>" /></td>
	</tr>
	<tr>
		<td>狀態:</td>
		<td><input type="TEXT" name="mem_sta" size="45" value="<%=memVO.getMem_sta()%>" /></td>
	</tr>
