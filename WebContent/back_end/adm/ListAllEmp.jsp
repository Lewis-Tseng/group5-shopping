...
<!--  	********************************************************************************************************** -->
				...
				<%-- 錯誤表列 --%>
					<c:if test="${not empty errorMsgs}">
					 ...
					 <h4><a href="<%=request.getContextPath()%>/back_end/adm/SelectEmp.jsp">回到員工查詢</a></h4>
...
<jsp:useBean id="empSvc" scope="page" class="com.administrator.model.AdmService"/>
<%@ include file="pages/page1.file" %> 
	<c:forEach var="admVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			<span><img style="width:150px;heigh:150px" src="<%=request.getContextPath()%>/EmpReaderPicServlet?emp_id=${admVO.emp_id} "></span> 
			</td>
