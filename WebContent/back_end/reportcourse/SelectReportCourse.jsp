...
<!--  	********************************************************************************************************** -->
				...
				<div class="container-fluid">
					...
					<ul>
						<li><a href='ListAllCourse.jsp'>CourseList</a> all Course. <br> <br></li>

						<li>
							<FORM METHOD="post" ACTION="reportcrs.do" id="form1">
								<b>輸入課程編號:</b> 
						...
						<li>
							<FORM METHOD="post" ACTION="reportcrs.do">
								<b>選擇課程名稱:</b> <select size="1" name="crsname">
									<c:forEach var="crsVO" items="${crsSvc.all}">
										<option value="${crsVO.crs_no}">${crsVO.crs_name}
									</c:forEach>
								</select> <input type="hidden" name="action" value="getOne_For_crsname">
								<input type="submit" value="送出">
							</FORM>
						</li>
					</ul>
