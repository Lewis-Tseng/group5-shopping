...
<%
	CourseReportVO  reportcrsVO=(CourseReportVO )request.getAttribute("reportcrsVO");
%>
<!DOCTYPE html>
<html lang="en">
...
<!--  	********************************************************************************************************** -->
        <!-- End of Topbar -->
		 <h3>修改檢舉課程內容 - UpdateCourse.jsp</h3></td><td>
		 <h4><a href="SelectReportCourse.jsp">回最檢舉課程管理</a></h4>
        <!-- Begin Page Content -->
	 ...
	 <form METHOD="post" ACTION="reportcrs.do"name="form1" id="form">
		<table>
				<tr><td>檢舉課程編號:</td>
				<td><%=reportcrsVO.getCrs_repid()%></td>
				</tr>
				<tr>
				<td>課程編號:<font color=red><b>*</b></font></td><br>
				<td><input type="text" name="crsid"
					value="<%=reportcrsVO.getCrs_no()%>" /></td>
				</tr>
				<tr>
					<td>檢舉內容:</td><br>
					<td><textarea name="content" style="width: 300px; height: 100px;"
						value="<%=reportcrsVO.getRep_content() %>"></textarea></td>	
					</tr>
				<tr>	
				...
				<input type="hidden" name="rep_id" value="<%=reportcrsVO.getCrs_repid()%>">
