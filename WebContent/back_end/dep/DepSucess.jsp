...
<!---------------------------------------信用卡----------------------------------------------------------------->
  ...
  Swal.fire({
  title: '<strong><u>儲值成功!!!趕快去逛逛我們的商城或是購買我們的課程吧</u></strong>',
  type: 'success',
  html:
    '<b>個人頁面</b>, ' +
    '<a href="<%=request.getContextPath()%>/front_end/mem/MemManagePersonal.jsp">^_^</a> ' ,
  showCloseButton: true,
  showCancelButton: true,
  focusConfirm: false,
  confirmButtonText:
    '<i class="fa fa-thumbs-up"></i><a href="index.html">購物商城</a>',
  confirmButtonAriaLabel: 'Thumbs up, great!',
  cancelButtonText:
    '<i class="fa fa-thumbs-down"><a href="index.html"></i>課程&教練</a>',
