...
<table>
	...
	<%-- 		<td><c:forEach var="deptVO" items="${deptSvc.all}">
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/dep/dep.do" style="margin-bottom: 0px;">
			     <input type="submit" value="修改">
			     <input type="hidden" name="dep_id"  value="${depVO.dep_id}">
