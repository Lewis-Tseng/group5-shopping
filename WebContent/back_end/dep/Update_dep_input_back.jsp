...
<%
  DepVO depVO = (DepVO) request.getAttribute("depVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
<html lang="en">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <table id="table-1">
	<tr><td>
		 <h3>儲值資料修改 - update_dep_input.jsp</h3>
		 <h4><a href="<%=request.getContextPath()%>/back_end/dep/Depositcheck_back.jsp"><img src="images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		<td>儲值編號:<font color=red><b>*</b></font></td>
		<td><%=depVO.getDep_id()%></td>
	</tr>
	<tr>
		<td>會員編號:</td>
		<td><input type="TEXT" name="mem_id" size="45" value="<%=depVO.getMem_id()%>" /></td>
	</tr>
	<tr>
		<td>教練編號:</td>
		<td><input type="TEXT" name="coa_id" size="45"	value="<%=depVO.getCoa_id()%>" /></td>
	</tr>
	<tr>
		<td>儲值金額:</td>
		<td><input type="TEXT" name="dep_money" size="45"	value="<%=depVO.getDep_money()%>" /></td>
	</tr>
	<tr>
		<td>儲值時間:</td>
		<td><input name="dep_day" id="f_date1" type="text" ></td>
	</tr>
	<tr>
		<td>儲值狀態:</td>
		<td><input type="TEXT" name="dep_sta" size="45" value="<%=depVO.getDep_sta()%>" /></td>
	</tr>
...
<input type="hidden" name="dep_id" value="<%=depVO.getDep_id()%>">
