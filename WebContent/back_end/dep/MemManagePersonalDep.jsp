...
<!-- ***************************************頭像名字(個人資料)********************************************** -->
		...
		<%=memVO.getMem_name()+"歡迎"+"  "+"您的點數餘額:"+memVO.getMem_point()%></span> 
		</a>
		</li>
	<%}%>
						</ul>
...
<!---------------------------------------信用卡----------------------------------------------------------------->
    ...
    <div class="form-container depform">
    ...
    <div class="depform">
    <form method="post" action="<%=request.getContextPath()%>/dep/dep.do">
      ...
      <input type="submit" value="儲值" class="add"></p>
	 	儲值後總金額 
		<div	id="bbb" style="border: 1px solid red; height: 55px;width: 200px;border-radius: 30px;text-align:center;line-height:55px;"></div>
</form>
    </div>
    </div>
...
$("#appoint").keyup(function(){
	 $.ajax({  
	   url:'<%=request.getContextPath() %>/PointAjaxServlet.do',
	   type:"POST",
	   data:{
