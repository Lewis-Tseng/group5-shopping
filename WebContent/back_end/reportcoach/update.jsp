...
<!--  	********************************************************************************************************** -->
        ...
        <!-- End of Topbar -->
		 ...
		 <h4><a href="SelectReportCoach.jsp">回最檢舉教練管理</a></h4>
        <!-- Begin Page Content -->
	 ...
	 <form METHOD="post" ACTION="reportcoa.do"name="form1" id="form">
		<table>
				<tr><td>檢舉編號:</td>
				<td><%=reportcoaVO.getRep_id()%></td>
				</tr>
				<tr>
				<td>教練編號:<font color=red><b>*</b></font></td><br>
				<td><input type="text" name="coach_id" value="<%=reportcoaVO.getCoa_id()%>" /></td>
				</tr>
				<tr>
					<td>檢舉內容:</td><br>
					<td><textarea name="content" style="width: 300px; height: 100px;" value="<%=reportcoaVO.getRep_cot() %>"></textarea></td>	
					</tr>
				<tr>	
				...
				<input type="hidden" name="rep_id" value="<%=reportcoaVO.getRep_id()%>">
