...
<!--  	********************************************************************************************************** -->
				...
				<div class="container-fluid">
					...
					<ul >
						<li><a href='ListAllCoach.jsp'>CoachList</a> all Coach. <br> <br></li>
						<jsp:useBean id="coaSvc" scope="page" class="com.coach.model.CoaService" />
						<li>
							<FORM METHOD="post" ACTION="reportcoa.do" id="form" >
								<b>輸入教練編號(如CO00001):</b><br>
						...
						<jsp:useBean id="reportcoaSvc" scope="page"
							class="com.reportcoa.model.ReportCoaService" />

						<li>
							<FORM METHOD="post"
								ACTION="reportcoa.do">
								<b>選擇教練名字:</b> <select size="1" name="coachid">
