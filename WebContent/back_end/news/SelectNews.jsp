...
<!--  	********************************************************************************************************** -->
				...
				<div class="NewsSearch">
						...
						<li>
							<FORM METHOD="post" ACTION="news.do" id="form1">
								<b>輸入最新消息編號 (如NW00001):</b> <input type="text" name="newsid">
						...
						<li>
							<FORM METHOD="post"
								...
								<b>選擇消息編號:</b> <select size="1" name="newsid">
									<c:forEach var="newsVO" items="${newsSvc.all}">
										<option value="${newsVO.news_id}">${newsVO.news_id}
									</c:forEach>
						...
						<li>
							<FORM METHOD="post"
								ACTION="<%=request.getContextPath()%>/back_end/news/news.do">
								<b>選擇消息標題:</b> <select size="1" name="newsid">
									<c:forEach var="newsVO" items="${newsSvc.all}">
										<option value="${newsVO.news_id}">${newsVO.news_title}
									</c:forEach>
								</select> <input type="hidden" name="action" value="getOne_For_Display">
								<input type="submit" value="送出">
							</FORM>
					...
					<ul>
						<li><a href='AddNews.jsp'>Add</a>增加最新消息.</li>
					</ul>
			</div>
</div>
