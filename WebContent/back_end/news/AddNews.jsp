...
<!--  	********************************************************************************************************** -->
				...
				<td>
					...
					<div class="container-fluid">
						...
						<h4>
							<a href="SelectNews.jsp">回最新消息管理</a>
						</h4>
						<form METHOD="post" ACTION="news.do" name="form1" id="form1"
							enctype="multipart/form-data">
							輸入消息編號<input type="text" name="newsid"
								value="<%=(newsVO == null) ? "" : newsVO.getNews_id()%>" /><br>
							輸入消息標題<input type="text" name="title"
								value="<%=(newsVO == null) ? "" : newsVO.getNews_title()%>" /><br>
							輸入消息內容<input type="text" name="content"
								value="<%=(newsVO == null) ? "" : newsVO.getNews_info()%>" /><br>
							消息發布時間: <input name="date" id="date" type="text"> <br>
							上傳消息圖片<input type="file" name="file" onchange="loadFile(event)" 
								value="<%=(newsVO == null) ? "" : newsVO.getNews_pic()%>" /><br>
							<img id="output0" /> <br>
