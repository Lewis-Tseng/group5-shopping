	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.jsp"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>後臺管理員</span></a>
			</li>
				...
				<div class="container-fluid">
					...
					<table class="newstable">
						...
						<tr>
								...
								<td>${newsVO.news_info}</td>
								<td><img  src="<%=request.getContextPath()%>/ReaderPicture?news_id=${newsVO.news_id}"></td>
