...
<html lang="en">
	<head>
		...
		<title>商品訂單資料 - listOneProduct_Order.jsp</title>
...
<!--  	********************************************************************************************************** -->
											...
											<div class="card shadow mb-4 dataTable">
												<div class="card-header py-3">
													<h6 class="m-0 font-weight-bold text-primary">商品訂單資料  <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
												</div>
												<div class="card-body">
														...
														<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
															...
															<tbody>
																<tr>
																	...
																	<td><%=product_orderVO.getOrd_dat()%></td>
																	<td><%=product_orderVO.getOrd_amo()%></td>
																	<td><%=product_orderVO.getPro_qua()%></td>
																	<td><c:if test="${product_orderVO.ord_sta == 0}">已付款</c:if>
																		<c:if test="${product_orderVO.ord_sta == 1}">已完成訂單</c:if></td>
																	<td><%=product_orderVO.getPay_met()%></td>
																	<td><%=product_orderVO.getDel_add() %></td>
