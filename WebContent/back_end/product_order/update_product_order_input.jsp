...
<%
Product_OrderVO product_orderVO = (Product_OrderVO) request.getAttribute("product_orderVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<!--  	********************************************************************************************************** -->
											...
											<div class="card shadow mb-4 dataTable">
												<div class="card-header py-3">
													<h6 class="m-0 font-weight-bold text-primary">商品訂單資料修改  <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
												</div>
												<div class="card-body">
													<div class="table-responsive">
														<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/product_order/product_order.do" name="form1">
															<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
																<tr>
																	<td>訂單編號</td>
																	<td><%=product_orderVO.getOrd_no()%></td>
																</tr>
																<tr>
																	<td>會員編號</td>
																	<td><%=product_orderVO.getMem_id()%></td>
																</tr>
																<tr>
																	<td>訂單總金額</td>
																	<td><input type="TEXT" name="ord_amo" size="20" value="<%=product_orderVO.getOrd_amo()%>" /></td>
																</tr>
																<tr>
																	<td>訂單日期</td>
																	<td><input name="ord_dat" id="f_date1" type="text"></td>
																</tr>
																<tr>
																	<td>商品總數量</td>
																	<td><input type="TEXT" name="pro_qua" size="8" value="<%=product_orderVO.getPro_qua()%>" /></td>
																</tr>
																<tr>
																	<td>訂單狀態</td>
																...
																<tr>
																	<td>配送地址</td>
																	<td><input type="TEXT" name="del_add" size="45" value="<%=product_orderVO.getDel_add()%>" /></td>
																</tr>
															</table>
															<input type="hidden" name="action" value="update">
															<input type="hidden" name="ord_no"  value="<%=product_orderVO.getOrd_no()%>">
															<input type="hidden" name="mem_id"  value="<%=product_orderVO.getMem_id()%>">
											...
											<div class="card shadow mb-4 dataTable">
												<div class="card-header py-3">
													<h6 class="m-0 font-weight-bold text-primary">商品訂單明細資料修改 ==== <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
												</div>
												<div class="card-body">
													<div class="table-responsive">
														<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
															...
															<tbody>
																	...
																	<tr><td>
																		${order_detailsVO.ord_no}
																	</td>
																	<td>${productSvc.getOneProduct(order_detailsVO.pro_no).pro_nam}
																	</td>
																	<td>${order_detailsVO.quantity}</td>
																	<td>${order_detailsVO.uni_pri}</td>
																	
																	<td><FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/order_details/order_details.do" style="margin-bottom: 0px;">
																		<input type="submit" value="修改">
																		<input type="hidden" name="ord_no"  value="${order_detailsVO.ord_no}">
																		<input type="hidden" name="pro_no"  value="${order_detailsVO.pro_no}">
...
<!--***************************************************** Logout 結束*****************************************************************************  -->
							...
							theme: '',              //theme: 'dark',
								...
								format:'Y-m-d',         //format:'Y-m-d H:i:s',
									value: '<%=product_orderVO.getOrd_dat()%>', // value:   new Date(),
