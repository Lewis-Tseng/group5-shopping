...
<html lang="en">
	<head>
		...
		<title>商品訂單資料新增 - addProduct_Order.jsp</title>
...
<!--  	********************************************************************************************************** -->
											...
											<div class="container-fluid">
												...
												<table id="table-1">
													<tr><td>
													<h3>商品訂單資料新增 - addProduct_Order.jsp</h3></td><td>
													<h4><a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
												</td></tr>
											</table>
											<h3>資料新增:</h3>
											<%-- 錯誤表列 --%>
											...
											<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/product_order/product_order.do" name="form1">
												<table>
													<tr>
														...
														value="<%= (product_orderVO==null)? "ME00003" : product_orderVO.getMem_id()%>" /></td>
													</tr>
													<tr>
														<td>訂單總金額:</td>
														<td><input type="TEXT" name="ord_amo" size="45"
														value="<%= (product_orderVO==null)? "MANAGER" : product_orderVO.getOrd_amo()%>" /></td>
													</tr>
													<tr>
														<td>訂單日期:</td>
													...
													<tr>
														<td>商品總數量:</td>
														<td><input type="TEXT" name="pro_qua" size="45"
														value="<%= (product_orderVO==null)? "10000" : product_orderVO.getPro_qua()%>" /></td>
													</tr>
													<tr>
														<td>訂單狀態:</td>
													...
													<tr>
														<td>配送地址:</td>
														<td><input type="TEXT" name="del_add" size="45"
														value="<%= (product_orderVO==null)? "10000" : product_orderVO.getDel_add()%>" /></td>
													</tr>
												</table>
												<br>
...
<!--***************************************************** Logout 結束*****************************************************************************  -->
						...
						try {
						ord_dat = product_orderVO.getOrd_dat();
						} catch (Exception e) {
