...
<%@page import="com.product_image.model.Product_ImageService"%>
...
<%-    List<ProductVO> list = productSvc.getAll();
	...
	List<Product_ImageVO> list = product_imageSvc.getAll();
		pageContext.setAttribute("list", list);
		%>
		...
		<html lang="en">
			<head>
				...
				<title>所有商品圖片資料 - listAllProduct_Image.jsp</title>
...
<!--  	********************************************************************************************************** -->
													...
													<div class="card shadow mb-4 dataTable">
														<div class="card-header py-3">
															<h6 class="m-0 font-weight-bold text-primary">所有商品圖片資料 <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
														</div>
														<div class="card-body">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<td>
																				...
																				<td><input type="submit" value="修改"> <!--            <input type="hidden" name="pro_img_no"  value=""> -->
																			...
																			<td>
																				...
																				<td><input type="submit" value="刪除"> <!--            <input type="hidden" name="pro_no"  value=""> -->
