...
<html lang="en">
	<head>
		...
		<title>商品圖片資料 - listOneProduct_Image.jsp</title>
...
<!--  	********************************************************************************************************** -->
											...
											<div class="card shadow mb-4 dataTable">
												<div class="card-header py-3">
													<h6 class="m-0 font-weight-bold text-primary">商品圖片資料 <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
												</div>
												<div class="card-body">
															...
															<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
																...
																<tbody>
																	<tr>
																		...
																		<td>
																			<img src="<%=request.getContextPath()%>/Reader_Image?pro_img_no=<%=product_imageVO.getPro_img_no() %>"  title="400px" width="200" border="1"/>
																		</td>
																		<td><%=product_imageVO.getPro_img_no()%></td>
																	</tr>
																</tbody>
															</table>
														</FORM>
