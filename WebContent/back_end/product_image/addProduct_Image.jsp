...
<%
Product_ImageVO product_imageVO = (Product_ImageVO) request.getAttribute("product_imageVO");
%>
...
<html lang="en">
	<head>
		...
		<title>商品資料新增 - addProduc.jsp</title>
...
<!--  	********************************************************************************************************** -->
											...
											<div class="card shadow mb-4 dataTable">
												<div class="card-header py-3">
													<h6 class="m-0 font-weight-bold text-primary">所有商品圖片 <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
												</div>
												<div class="card-body">
													<div class="table-responsive">
														<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/product_image/product_image.do" name="form1" enctype="multipart/form-data">
															<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
																...
																<tbody>
																	<tr>
																		<td><select size="1" name="pro_no">
																			<c:forEach var="productVO" items="${productSvc.all}">
																			<option value="${productVO.pro_no}">${productVO.pro_no} == ${productVO.pro_nam}
																				</c:forEach>
																			</select></td>
																			<td><input type="TEXT" name="img_nam" size="45"
																			value="<%=(product_imageVO == null) ? "請輸入商品圖片名稱" : product_imageVO.getImg_nam()%>" /></td>
																		</tr>
																	</tbody>
																</table>
													...
													<div class="card shadow mb-4 dataTable">
														...
														<div class="card-body">
															<div class="table-responsive">
																...
																<div id="table_btn"><input type="hidden" name="action" value="insert">
																<input type="submit" value="送出新增"></div>
															</FORM>
														</div>
													</div>
												</div>
