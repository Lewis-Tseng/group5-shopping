...
<%
Product_CategoryVO product_categoryVO = (Product_CategoryVO) request.getAttribute("product_categoryVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<!--  	********************************************************************************************************** -->
											...
											<div class="card shadow mb-4 dataTable">
												<div class="card-header py-3">
													<h6 class="m-0 font-weight-bold text-primary">商品類別資料修改 <a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
												</div>
												<div class="card-body">
													<div class="table-responsive">
														<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/product_category/product_category.do" name="form1" >
															<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
																...
																<tbody>
																	<tr>
																		<td><%=product_categoryVO.getCat_no()%></td>
																		<td><input type="TEXT" name="cat_nam" size="45"
																		value="<%=(product_categoryVO==null)? "請輸入類別名稱" : product_categoryVO.getCat_nam()%>" /></td>
																	</tr>
																</tbody>
															</table>
															<input type="hidden" name="action" value="update">
															<input type="hidden" name="cat_no" value="<%=product_categoryVO.getCat_no()%>">
