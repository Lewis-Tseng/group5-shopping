...
List<Product_CategoryVO> list = product_categorySvc.getAll();
	...
	<html lang="en">
		<head>
			...
			<title>所有商品類別資料 - listAllProduct_Category.jsp</title>
...
<!--  	********************************************************************************************************** -->
												...
												<div class="card shadow mb-4 dataTable">
													<div class="card-header py-3">
														<h6 class="m-0 font-weight-bold text-primary">所有商品類別資料<a href="<%=request.getContextPath()%>/back_end/product/select_Product.jsp">回首頁</a></h6>
													</div>
													<div class="card-body">
															...
															<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/product_category/product_category.do" name="form1" >
																<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
																	...
																	<tbody>
																		...
																		<tr>
																			<td>${Product_CategoryVO.cat_no}</td>
																			<td>${Product_CategoryVO.cat_nam}</td>
																			<td>
																				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/product_category/product_category.do" style="margin-bottom: 0px;">
																					<input type="submit" value="修改">
																					<input type="hidden" name="cat_no"  value="${Product_CategoryVO.cat_no}">
