...
<%@page import="com.gro.report.reportDAO"%>
...
<jsp:useBean id="groupSvc" scope="page" class="com.gro.group.groupService" />
...
<!-- ****************************功能項目開始************************************************************************** -->
		...
		<!-- Nav Item - Utilities Collapse Menu -->
		  ...
		  <li class="nav-item">
			...
			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsepoint"
			...
			<!-- Nav Item - Tables -->
		<li class="nav-item"><a class="nav-link collapsed" href="#"data-toggle="collapse" data-target="#collapseAd"
				aria-expanded="true" aria-controls="collapseAd">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseReport"
				...
				<div class="container-fluid">
					...
					<table class="newstable">
						...
						<c:forEach var="reportVO" items="${list}" >
							<tr>
								<td>${reportVO.gro_repid}</td>
								<td>${groupSvc.getOneGro(reportVO.gro_id).gro_name}</td>
								<td>${reportVO.gro_rep_info}</td>
								<td>
								<c:if test="${reportVO.gro_rep_stat == '1'}">已處理</c:if>
								<c:if test="${reportVO.gro_rep_stat == '0'}">未處理</c:if>
			  					 </td>
								<td>
									<FORM METHOD="post"ACTION="<%=request.getContextPath()%>/back_end/group_report/reportgroup.do"
									style="margin-bottom: 0px ">
										<input type="submit" value="修改狀態">
										<input type="hidden"name="gro_rep_stat" value="${reportVO.gro_rep_stat}"> 
										<input type="hidden"name="gro_repid" value="${reportVO.gro_repid}"> 
										<input type="hidden" name="BF_url" value="/back_end">
										<input type="hidden" name="action" value="update">
									</FORM>
								</td>
								<td>
									<FORM METHOD="post"
										ACTION="<%=request.getContextPath()%>/back_end/group_report/reportgroup.do"
										style="margin-bottom: 0px;">
										<input type="submit" value="刪除"> <input type="hidden"
											name="gro_repid" value="${reportVO.gro_repid}"> 
											<input type="hidden" name="BF_url" value="/back_end">
