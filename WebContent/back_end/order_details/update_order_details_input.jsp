...
<%
Order_DetailsVO order_detailsVO = (Order_DetailsVO) request.getAttribute("order_detailsVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>商品訂單明細資料修改 - update_order_details_input.jsp</title>
                      ...
                      <div class="card shadow mb-4 dataTable">
                        ...
                        <div class="card-body">
                          <div class="table-responsive">
                            <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/order_details/order_details.do" name="form1">
                              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <tr>
                                  ...
                                  <tr>
                                    <td>商品數量</td>
                                    <td><input type="TEXT" name="quantity" size="20"  value="<%=order_detailsVO.getQuantity()%>" /></td>
                                  </tr>
                                  <tr>
                                    <td>商品價格</td>
                                    <td><input type="TEXT" name="uni_pri" size="20" value="<%=order_detailsVO.getUni_pri()%>" /></td>
                                  </tr>
                                </tr>
                              </table>
