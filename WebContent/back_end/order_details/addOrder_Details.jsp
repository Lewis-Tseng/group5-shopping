...
<%
Order_DetailsVO order_detailsVO = (Order_DetailsVO) request.getAttribute("order_detailsVO");
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>訂單明細資料新增 - addOrder_Details.jsp</title>
                      ...
                      <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/order_details/order_details.do" name="form1">
                        <table>
                          ...
                          <tr>
                            ...
                            value="<%= (order_detailsVO==null)? "100" : order_detailsVO.getQuantity()%>" /></td>
                          </tr>
                          <tr>
                            <td>商品價格:</td>
                            <td><input type="TEXT" name="uni_pri" size="45"
                            value="<%= (order_detailsVO==null)? "10000" : order_detailsVO.getUni_pri()%>" /></td>
                          </tr>
