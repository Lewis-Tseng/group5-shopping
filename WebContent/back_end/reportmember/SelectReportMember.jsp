	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>後臺管理員</span></a>
			</li>
...
<!--  	********************************************************************************************************** -->
				...
				<div class="container-fluid">
					...
					<ul>
						<li><a href='ListAllMember.jsp'>Member</a> all Member <br> <br></li>

						<li>
							<FORM METHOD="post" ACTION="reportmem.do" id="form1">
								<b>輸入會員編號(如ME00001):</b> <input type="text" name="memid">
								<input type="hidden" name="action" value="getOne_For_Display">
								<input type="submit" value="送出">
							</FORM>
						</li>

						<jsp:useBean id="reportmemSvc" scope="page"
							class="com.reportmem.model.ReportMemService" />

						<li>
							<FORM METHOD="post"
								ACTION="reportmem.do">
								<b>選擇會員編號:</b> <select size="1" name="memid">
									<c:forEach var="reportmemVO" items="${reportmemSvc.all}">
										<option value="${reportmemVO.mem_id}">${reportmemVO.mem_id}
									</c:forEach>
