...
<%@page import="com.reportmem.model.ReportMemVO"%>
<%@page import="com.reportmem.model.ReportMemService"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>

<%
	ReportMemVO reportmemVO=(ReportMemVO)request.getAttribute("reportmemVO");
%>
...
<!--  	********************************************************************************************************** -->
        <!-- End of Topbar -->
		 <h3>修改檢舉教練內容 - UpdateCoach.jsp</h3></td><td>
		 <h4><a href="SelectReportMember.jsp">回最檢舉會員管理</a></h4>
        <!-- Begin Page Content -->
		...
		out.print(${reportmemVO.rep_id});
		</c:if>
	 <form METHOD="post" ACTION="reportmem.do"name="form1" id="form">
	<jsp:useBean id="reportmemSvc" scope="page" class="com.reportmem.model.ReportMemService" />
		<table>
				<tr><td>檢舉編號:</td>
				<td><%=reportmemVO.getRep_id()%></td>
				</tr>
				<tr>
				<td>會員編號:<font color=red><b>*</b></font></td><br>
				<td><input type="text" name="memid"
					value="<%=reportmemVO.getMem_id()%>" /></td>
				</tr>
				<tr>
					<td>檢舉內容:</td><br>
					<td><textarea name="content" style="width: 300px; height: 100px;"
						value="<%=reportmemVO.getRep_cot() %>"></textarea></td>	
					</tr>
				<tr>	
						<td>輸入檢舉狀態<select name="rep_sta">
				...
				<input type="hidden" name="rep_id" value="<%=reportmemVO.getRep_id()%>">
