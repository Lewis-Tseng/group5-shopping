	...
	<td>
		...
		<div class="container-fluid">
			...
			<div>
				...
				<tr><th style="color:#c3585e">檢舉功能：檢舉課程</th></tr>
				<tr><th style="color:#c3585e">課程名稱:</th></tr>
				<tr><th>
				<select size="1" name="crsid" id="select">
						<c:forEach var="crsVO" items="${crsSvc.all}">
							<option value="${crsVO.crs_no}"
								${(crsVO.crs_no == crsVO.crs_no) ? 'selected':'' }>${crsVO.crs_name}
						</c:forEach>
				</select>
				</th> 
				</tr> 
				<tr ><th style="color:#c3585e">輸入檢舉課程內容</th></tr>
				<tr>
				<th>
				<textarea id="content" name="content" value="<%=(reportcrsVO == null) ? "" : reportcrsVO.getRep_content()%>" style="width: 750px; height: 350px;"></textarea>
				<br>
