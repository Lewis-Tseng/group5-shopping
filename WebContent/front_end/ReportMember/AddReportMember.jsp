	...
	<!-- Sidebar END -->
		...
		<div class="container-fluid">
			...
			<div>
				...
				<tr><th style="color:#c3585e">檢舉功能：檢舉會員</th></tr>
				<tr><th style="color:#c3585e">會員名字:</th></tr>
				<tr><th>
				<select size="1"  id="select">
					<c:forEach var="memVO" items="${memSvc.all}">
						<option value="${memVO.mem_id}"
								${(memVO.mem_id==memVO.mem_id)? 'selected':'' }>${memVO.mem_name}
					</c:forEach>
				</select>
				</th> 
				</tr> 
				<tr ><th style="color:#c3585e">輸入檢舉內容</th></tr>
				<tr>
				<th>
				<textarea id="content" name="content" <%=(reportmemVO == null) ? "" : reportmemVO.getRep_cot()%>" style="width: 750px; height: 350px;"></textarea>
				<br>
