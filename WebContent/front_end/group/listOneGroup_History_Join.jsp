	...
	$('.memPic').mouseleave(function(){
		$('.memInfo').css("opacity","0");
			...
			<div class="banner wow fadeInDownBig animated animated" data-wow-delay="0.4s">
				<div class="container">
					<h2 style="color: rgb(70,70,70);font-family: test,微軟正黑體;width:500px;margin:0 auto;margin-left: 45%;">揪團資訊/歷史</h2>
				</div>
			</div>
		<!---about-->
									...
									<div class="pop-up pop5" style="font-family:'test';background-color: rgba(25,25,25,0.95);">
										<div class="content">
											<div class="container">
												...
												<img src="<%=request.getContextPath()%>/front_end/css_group/images/bye.png" alt="Car">
