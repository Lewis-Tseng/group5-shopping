...
<%
	...
	List<groupVO> list = groupSvc.getGroByMem(mem_id);
...
<!---banner--->
			...
			<div class="banner wow fadeInDownBig animated animated" data-wow-delay="0.4s">
				<div class="container">
					<h4 style="color: rgb(70,70,70); font-family: test,微軟正黑體;font-size:50px;margin-left: 30%;">我建立的揪團</h4>
				</div>
			</div>
		<!---about-->
												...
												<div class="data">
													<div class="contents">
														...
														<FORM METHOD="post" ACTION="group.do">
															...
															<input type="hidden" name="action" value="getOne_For_Display_Create"> 
...
<!-- 															<input type="hidden" name="BF_url" value="/front_end">  -->
<!-- 															<a href="#" class="button" style="font-family:'test';"> -->
<!-- 															<input type="submit" value="修改揪團"></input></a> -->
<!-- 														</FORM> -->
<!-- 														</div> -->
<!-- 														<div> -->
<!-- 														<FORM METHOD="post" ACTION="group.do"> -->
...
<!-- 															<input type="hidden" name="BF_url" value="/front_end">  -->
<!-- 															<a href="#" class="button" style="font-family:'test';"> -->
<!-- 															<input type="submit" value="刪除揪團"></input></a> -->
<!-- 														</FORM> -->
														</div>
