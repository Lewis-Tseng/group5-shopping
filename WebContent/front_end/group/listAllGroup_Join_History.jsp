...
MemVO memVO = (MemVO) session.getAttribute("memVO");
	...
	Set<joingroupVO> joingroupVO =groupjoinSvc.getAllGros(memVO.getMem_id());
	List<groupVO> list = new ArrayList<groupVO>();
	
	for (joingroupVO aGro_id:joingroupVO) {
		groupVO groupInfo = groupSvc.getOneGroWithStatHistory(aGro_id.getGro_id());
		if(groupInfo!=null){
			list.add(groupInfo);
		}
	}
	...
	$('.memPic').mouseleave(function(){
		$('.memInfo').css("opacity","0");
			...
			<div class="banner wow fadeInDownBig animated animated" data-wow-delay="0.4s">
				<div class="container">
					<h4 style="color: rgb(70,70,70); font-family: test,微軟正黑體;font-size:50px;margin-left: 40%;">我曾經加入的揪團</h4>
				</div>
			</div>
		<!---about-->
												...
												<div class="data">
													<div class="contents">
														...
														<div class="groInfoDiv">
															...
															<input type="hidden" name="action" value="getOne_For_Display_HJoin"> 
