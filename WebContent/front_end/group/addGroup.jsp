	...
	$('.memPic').mouseleave(function(){
		$('.memInfo').css("opacity","0");
			...
			<div class="banner wow fadeInDownBig animated animated" data-wow-delay="0.4s">
				<div class="container">
					<h2 style="color: rgb(70,70,70);font-family: test,微軟正黑體;width:500px;margin:0 auto;margin-left: 45%;">建立揪團</h2>
				</div>
			</div>
		<!---about-->
							...
							<div class="form-style-5">
								...
								<form METHOD="post" ACTION="group.do" name="form1" enctype="multipart/form-data">
									<fieldset>
										...
										<h2>揪團名稱</h2>
										<input type="TEXT" name="gro_name" size="45" value="<%= (groupVO==null)? "" : groupVO.getGro_name()%>"/>
										<h2>最少人數</h2>
										<input type="TEXT" name="gro_mnum_min" size="45"value="<%= (groupVO==null)? "" : groupVO.getGro_mnum_min()%>"/>
										<h2>最多人數</h2>
										<input type="TEXT" name="gro_mnum_max" size="45"value="<%= (groupVO==null)? "" : groupVO.getGro_mnum_max()%>"/> 
										...
										<select size="1" name="gro_cid" id="list" name="list">
 										...
 										<!--圖片 -->
 										<h2>揪團LOGO</h2><br>
 										<img id="preview_1" src="<%=request.getContextPath()%>/front_end/css_group/images/G5_LOGO_v2.0.png" style="width:50%; padding-bottom: 20px;margin-left:25%;"/>
...
<!-- 										<input type="text" name="GRO_LOC" placeholder="揪團地點"> -->
										...
										<h2>揪團介紹</h2>
										<textarea name="gro_info" placeholder="揪團介紹" value="<%= (groupVO==null)? "" : groupVO.getGro_info()%>" style="height:200px;width:100%;"></textarea>
									</fieldset>
									<input type="hidden" name="mem_id" value="<%=memVO.getMem_id()%>"/>
									<input type="hidden" name="action" value="insert">
									<input type="hidden" name="BF_url" value="/front_end">
									<input style="font-family:'test'"type="submit" value="創建揪團" />
								</form>
							</div>
