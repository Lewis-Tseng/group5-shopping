...
<%
	...
	for (joingroupVO aGro_id:joingroupVO) {
		groupVO groupInfo = groupSvc.getOneGroWithStat(aGro_id.getGro_id());
		if(groupInfo!=null){
			list.add(groupSvc.getOneGroWithStat(aGro_id.getGro_id()));
		}
	}
	...
	$('.memPic').mouseleave(function(){
		$('.memInfo').css("opacity","0");
			...
			<div class="banner wow fadeInDownBig animated animated" data-wow-delay="0.4s">
				<div class="container">
					<h4 style="color: rgb(70,70,70); font-family: test,微軟正黑體;font-size:50px;margin-left: 30%;">我加入的揪團</h4>
				</div>
			</div>
		<!---about-->
												...
												<div class="data">
													<div class="contents">
														...
														<div class="groInfoDiv">
															...
															<input type="hidden" name="action" value="getOne_For_Display_Join"> 
