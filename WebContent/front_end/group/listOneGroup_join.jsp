...
<%@page import="com.friendList.controller.*"%>
...
/* ==============================================CCCCCCCCCCCCCCCHHHHHHHHHHHHHHAAAAAAAAAAAATTTTTTTTTTTTTT */
.chatBtn img{
	position: fixed;
    right: 15;
    bottom: 80;
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------- -->
									<div class="pop-up pop1" style="font-family:'test';background-color: rgba(25,25,25,0.95);">
										<div class="content">
											<div class="container">
												...
												<div class="title">
													<h1 style="font-family:'test';">檢舉揪團</h1>
												</div>
												...
												<div class="subscribe">
													...
													<form>
														<input style="border-radius:30px;" type="text" name="gro_rep_info" value="<%= (reportVO==null)? "" : reportVO.getGro_rep_info()%>"placeholder="檢舉內容"> 
														...
														<input style="top:auto;
																	  ...
																	  width: 25%;
																	  background-color: rgba(229,215,121,1); 
																	  border: 1px solid rgba(229,215,121,1);"
															class="report_btn" name="alert"type="hidden" value="送出">
													</form>
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------- -->
									<div class="pop-up pop2" style="font-family:'test';background-color: rgba(25,25,25,0.95);">
										<div class="content">
											<div class="container" style="padding-top: 40px;padding-bottom: 120px;">
												...
												<div class="title">
													<h1 style="font-family:'test';">評價揪團</h1>
												</div>

												<img src="<%=request.getContextPath()%>/front_end/css_group/images/star.png" alt="Car">
												...
												<div class="subscribe">
													...
													<form>
														...
														<input type="radio" name="stars" id="star-null" value="-1" checked/>
													...
													<section class="a1" style="margin: auto;">
														<label for="star-1"> 
														...
														<input type="hidden" name="BF_url" value="/front_end">
														<c:set var="stat" scope="request" value="<%=joingroupSvc.getOneStar(groupVO.getGro_id(), mem_id).getGro_star()%>"/>
														<c:if test="${stat==-1}">
															<input style="top:auto;
																	  right:210;
																      bottom:-5;
																	  ...
																	  z-index:10;
																	  width: 25%;"
															class="stars_btn" name="starbtn"type="hidden" value="送出">
														</c:if>
														<c:if test="${stat!=-1}">
															<input style="top:auto;
																	  right:210;
																	  ...
																	  z-index:10;
																	  width: 25%;"
															class="stars_btn" name="starbtn"type="hidden" disabled="disabled" value="已評價">
														</c:if>
													</form>
												</div>
											</div>
									...
									<div class="pop-up pop5" style="font-family:'test';background-color: rgba(25,25,25,0.95);">
										<div class="content">
											<div class="container">
												...
												<div class="title">
													<h1 style="font-family:'test';color:rgba(255,86,95,0.9);">退出揪團</h1>
												</div>

												<img src="<%=request.getContextPath()%>/front_end/css_group/images/goodbye.png" alt="Car">

												<div class="subscribe">
													<h1 style="font-family:'test';">
														確定要<span style="color:rgba(255,86,95,0.9);">退出</span>嗎?
													</h1>

													<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front_end/group/joingroup.do">
														<input type="hidden" class="quit_btn" value="確認退出" style="top: auto;
    																											   right: 203;
    																											   bottom: -10;
    																											   box-shadow: none;
    																											   border-radius: 30px;
														...
														<input type="hidden" name="requestURL" value="<%=request.getServletPath()%>">
														<input type="hidden" name="BF_url" value="/front_end">
														<input type="hidden" name="action" value="delete_Join">
													</FORM>
												</div>
											</div>
										</div>
            	...
            	<c:if test="${memVO.mem_pic!=null}">
             	...
             	<c:if test="${memVO.mem_pic==null}">
             		<c:if test='${memberSvc.getOneMem(memVO.mem_id).mem_gender.equals("男")}'>
						<img src="<%=request.getContextPath()%>/front_end/css_group/images/men.png" style="width: 75px;height:75px;left:30px;top:5px;border-radius: 50%;margin: 11 0;margin-left: 20;">
					</c:if>
					<c:if test='${memberSvc.getOneMem(memVO.mem_id).mem_gender.equals("女")}'>
						<img src="<%=request.getContextPath()%>/front_end/css_group/images/women.png" style="width: 75px;height:75px;left:30px;top:5px;border-radius: 50%;margin: 11 0;margin-left: 20;">
					</c:if>
             	</c:if>
...
//  ------------------------------------------
    $('.btn1').click(function(){
        $('.pop1').addClass('open');
        $('.report_btn').attr('type','button');
      });

      $('.pop1 .close').click(function(){
        $('.pop1').removeClass('open');
        $('.report_btn').attr('type','hidden');
      });
//  ------------------------------------------
      $('.btn2').click(function(){
          $('.pop2').addClass('open');
