...
<!-- dudududu -->
<div class="little" style=" border: 1px solid var(--light); 
							width:100px;
							height:50px;
							margin-right: 100px;
							bottom: 100px
...
// 					   //遊覽器 標題更新
// 					$('title').html('新訊息! ${memVO.mem_name}的聊天室 ');
						//第一次 等於1
...
<!-- 抓取對方打字 暫時先不要這功能 -->
<!-- <script> -->
<!-- document.getElementById("inputplace").addEventListener("input", function(){ -->
<!-- //  	inputStatus.textContent=this.value; -->
<!--  	console.log("我正在打字"); -->
<!-- }); -->
<!-- </script> -->
