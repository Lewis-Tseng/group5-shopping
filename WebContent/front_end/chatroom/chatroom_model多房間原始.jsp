...
//老師範例初始化 開始-----------------------------------------------------------
var room = "ME00001"+'${memVO.mem_id}';
var MyPoint = "/MyEchoServer/" + '${memVO.mem_name}' + "/" + room;
...
// 	};
	...
	webSocket.onmessage = function(event) {
        ...
        $('<div class="bubble you"><p>' + message + '</p></div>').appendTo($('.chat.active-chat'));
        messagesArea.scrollTop = messagesArea.scrollHeight;
    	//左邊部分的預覽訊息更新
//     	$('.person.active .preview').html('<span>You: </span>' + message);
    	//應該是聊天訊息跳出的動畫???
