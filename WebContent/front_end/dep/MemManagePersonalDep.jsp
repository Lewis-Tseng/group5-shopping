...
<!---------------------------------------信用卡----------------------------------------------------------------->
<div  id="cardTest" class="col-md-8 map-middle wow fadeInRight animated animated" data-wow-delay="0.4s">	                    
<div class="container preload dep">
    
        <div class="creditcard" style="margin-left: 10%;">
            <div class="front">
            <h1 style="text-align: center";>會員儲值</h1>
                <div id="ccsingle"></div>
                <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">CHEN,YU-HSIN</text>
            ...
            <div class="back">
                <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                        ...
                        <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">200</text>
                        <g class="st8">
                            <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security code</text>
                        </g>
                        <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                        <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                        <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">CHEN,YU-HSIN</text>
                    </g>
                </svg>
            </div>
        </div>
    </div>
 <div id="Personalcard" class="form-container depform" >
...
<div class="depform">
<form method="post" action="<%=request.getContextPath()%>/dep/dep.do" id="deposit">
     <c:if test="${not empty errorMsgs}">
      ...
      <p>請輸入儲值金額 <input type="text" name="dep_money" id="appoint"
       style="margin-top:8%;text-align: center;font-size:20px;color:rgb(0,0,0)">
      <input type="hidden" name="action" value="insert_dep">
      <input type="submit" value="儲值" class="add"></p>
	 	儲值後總金額 
		<div id="bbb" style="border: 1px solid red; height: 55px;width: 100%;border-radius: 30px;text-align:center;line-height:55px;font-size:20px;color:rgb(0,0,0);background-color:lightgrey"></div>
</form>
</div>
</div>
...
$("#appoint").keyup(function(){
	 $.ajax({  
	   url:'PointAjaxServlet.do',
	   type:"POST",
	   data:{
		   mem_point : $("#appoint").val()
